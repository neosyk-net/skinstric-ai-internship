...
export default function Location({ label = "INTRO", className = "" }: LocationProps) {
  return (
    <div className={`ml-4 inline-flex h-[17px] items-center gap-[6px] whitespace-nowrap ${className}`}>
